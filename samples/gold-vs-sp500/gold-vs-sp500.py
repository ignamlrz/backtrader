...
class TestCalendar(bt.TradingCalendar):
    params = dict(
        holidays=[],
        earlydays=[],
...
def runstrat(args=None):
    ...
    cerebro.addcalendar(TestCalendar())
...
def parse_args(pargs=None):
    ...
    parser = argparse.ArgumentParser(
        ...
        description=("Gold vs SP500 from " "https://estrategiastrading.com/oro-bolsa-estadistica-con-python/"),
    )
